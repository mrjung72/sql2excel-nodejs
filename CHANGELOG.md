...
| 버전 | 주요 기능 | 릴리즈 일자 |
|------|-----------|-------------|
| **v1.2.1** | 문서화 개선, 사용자 매뉴얼 추가 | 2025-01-15 |
| **v1.2.0** | 쿼리 재사용, CLI 개선, 윈도우 배치 파일 | 2024-08-07 |
| **v1.1.0** | 자동 목차, 집계 기능, 다중 DB, 조회 제한 | 2024-07-22 |
| **v1.0.0** | 초기 릴리즈, 기본 엑셀 생성 기능 | 2024-01-15 |
